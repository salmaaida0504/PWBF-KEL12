                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-body card-body-custom pt-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">Cuci AC Inverter 0.5 - 2 PK</h5>
                                    <!-- Product price-->
                                    <div class="rent-price mb-3">
                                        <span class="text-primary">Rp 130.000/</span>day
                                    </div>
                                    <ul class="list-unstyled list-style-group">
                                        <li class="border-bottom p-2 d-flex justify-content-between">
                                            <p style="text-align: left">
                                                Pengecekan & pembersihan unit indoor/oudoor AC Inverter
                                            </p>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="card-footer border-top-0 bg-transparent">
                                <div class="text-center">
                                    ...
                                    <a class="btn btn-info mt-auto text-white" href="./detail.html">
                                        Detail
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <div class="card-body card-body-custom pt-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">Isi Freon R32/R410 1.5 2-PK</h5>
                                    <!-- Product price-->
                                    <div class="rent-price mb-3">
                                    ...
                                    <ul class="list-unstyled list-style-group">
                                        <li class="border-bottom p-2 d-flex justify-content-between">
                                            <p style="text-align: left">
                                                mengatasi AC tidak dingin karena freon R32/R410 Habis
                                            </p>
                                        </li>
                                    </ul>
                                </div>
