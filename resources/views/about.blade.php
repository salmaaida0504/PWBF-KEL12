    ...
    <div class="container-fluid page-header py-5 mb-5">
        <div class="container py-5">
            ...
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a class="text-white" href="{{ url('/homepage') }}">Home</a></li>
            ...
            <div class="container py-5">
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <a class="btn btn-link" href="">Perbaikan Komputer</a>
                        <a class="btn btn-link" href="">TV</a>
                        <a class="btn btn-link" href="">AC</a>
                        <a class="btn btn-link" href="">Mesin Cuci</a>
                        <a class="btn btn-link" href="">Microwave dan Oven</a>
                        <a class="btn btn-link" href="">Kulkas</a>
                    </div>
