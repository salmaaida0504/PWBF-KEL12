    ...
    <header class="bg-dark py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="text-center text-white">
                <h1 class="display-4 fw-bolder">Detail Layanan</h1>
            </div>
        </div>
    </header>
    <!-- Section-->
            ...
            <div class="col-lg-4 mb-5">
                <div class="card">
                        ...
                        <div class="card-body card-body-custom pt-4">
                            ...
                            <!-- Product name-->
                                <div class="d-flex justify-content-between align-items-center">
                                    <h5 class="fw-bolder">Cuci AC Inverter</h5>
                                        <div class="rent-price mb-3">
                                            <span style="font-size: 1rem" class="text-primary">Rp 130.000/</span>
                                            day
                                        </div>
                                </div>
                            </div>
                    ...
                    <div class="card-footer border-top-0 bg-transparent">
                        <div class="text-center">
                            <a class="btn d-flex align-items-center justify-content-center btn-primary mt-auto" href="#" style="column-gap: 0.4rem">
                                Ambil Layanan <i class="ri-whatsapp-line"></i>
                            </a>
                        </div>
                    </div>
                </div>
